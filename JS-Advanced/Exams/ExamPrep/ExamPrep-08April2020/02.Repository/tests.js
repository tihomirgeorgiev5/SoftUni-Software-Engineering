...
describe("Repository Tests", function () {
    ...
    describe("Initialize props object", function () {
    ...
    describe('Add entity', () => {
        it('Should return incremented id iv valid entity is added', () => {
    ...
    describe('Get count', () => {
        it('Should return num of entities', () => {
    ...
    describe('Update', () => {
        ...
        it('Should throw error, when updating invalid', () => {
